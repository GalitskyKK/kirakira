...
// Темы комнат: цены ~2 недели (3000 🌿/2 💎) — ~месяц (6000 🌿/4 💎) игры
const ROOM_THEMES = [
  {
    id: 'isoRoom',
  ...
  {
    id: 'white_default_room',
    name: 'Белая комната',
    priceSprouts: 1500,
    priceGems: 1,
    isDefault: false,
    previewUrl: '/isoRoom/white_default_room.webp',
  },
  {
    id: 'blue_default_room',
    name: 'Синяя комната',
    priceSprouts: 1500,
    priceGems: 1,
    isDefault: false,
    previewUrl: '/isoRoom/blue_default_room.webp',
  },
  {
    id: 'dark_blue_default_room',
    name: 'Тёмно-синяя комната',
    priceSprouts: 1500,
    priceGems: 1,
    isDefault: false,
    previewUrl: '/isoRoom/dark_blue_default_room.webp',
  },
  {
    id: 'orange_default_room',
