...
const RARITY_PREFIXES: Record<RarityLevel, string[]> = {
  [RarityLevel.COMMON]: [''],
  [RarityLevel.UNCOMMON]: ['Красивый', 'Приятный', 'Милый'],
  [RarityLevel.RARE]: ['Редкий', 'Особый', 'Изысканный'],
  [RarityLevel.EPIC]: ['Эпический', 'Величественный', 'Царственный'],
  [RarityLevel.LEGENDARY]: ['Легендарный', 'Божественный', 'Мифический'],
}
