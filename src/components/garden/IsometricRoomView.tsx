...
const SLOT_POSITIONS = {
  ...
  shelfTopLeft: { x: 0, y: 2.5, z: 10.5 }, // Верхняя полка, левая позиция
  shelfTopRight: { x: 0, y: 4.5, z: 10.5 }, // Верхняя полка, правая позиция
  shelfBottomLeft: { x: 0, y: 2.5, z: 7 }, // Нижняя полка, левая позиция
  shelfBottomRight: { x: 0, y: 4.5, z: 7 }, // Нижняя полка, правая позиция

  // Подоконник справа (4 слота: 4-7)
  windowSill1: { x: 3, y: 0.5, z: 7 }, // Подоконник, позиция 1
  windowSill2: { x: 4.75, y: 0.5, z: 7 }, // Подоконник, позиция 2
  windowSill3: { x: 6.5, y: 0.5, z: 7 }, // Подоконник, позиция 3
  windowSill4: { x: 8.25, y: 0.5, z: 7 }, // Подоконник, позиция 4

  // Стол (4 слота: 8-11)
  tableTopLeft: { x: 4.5, y: 5, z: 7 }, // Стол, верхний левый
  tableTopRight: { x: 6.5, y: 5, z: 7 }, // Стол, верхний правый
  tableBottomLeft: { x: 4.5, y: 6.5, z: 7 }, // Стол, нижний левый
  tableBottomRight: { x: 6.5, y: 6.5, z: 7 }, // Стол, нижний правый

  // Пол (4 слота: 12-15)
  floor1: { x: 3.0, y: 8.0, z: 3 }, // Пол, позиция 1
  floor2: { x: 4.5, y: 8.0, z: 3 }, // Пол, позиция 2
  floor3: { x: 6.0, y: 8.0, z: 3 }, // Пол, позиция 3
  floor4: { x: 7.5, y: 8.0, z: 3 }, // Пол, позиция 4
} as const
