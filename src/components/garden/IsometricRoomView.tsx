...
const SLOT_POSITIONS = {
  ...
  shelfTopRight: { x: 0, y: 4, z: 9.5 }, // Верхняя полка, правая позиция
  shelfBottomLeft: { x: 0, y: 1.5, z: 6 }, // Нижняя полка, левая позиция
  shelfBottomRight: { x: 0, y: 4, z: 6.5 }, // Нижняя полка, правая позиция

  // Подоконник справа (4 слота: 4-7)
  windowSill1: { x: 2, y: 0, z: 6 }, // Подоконник, позиция 1
  windowSill2: { x: 3.5, y: 0, z: 6 }, // Подоконник, позиция 2
  windowSill3: { x: 5, y: 0, z: 6 }, // Подоконник, позиция 3
  windowSill4: { x: 6.5, y: 0, z: 6 }, // Подоконник, позиция 4
