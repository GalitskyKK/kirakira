...
const SLOT_POSITIONS = {
  ...
  // Стол (4 слота: 8-11)
  tableTopLeft: { x: 4.5, y: 5, z: 3.95 }, // Стол, верхний левый
  tableTopRight: { x: 6.5, y: 5, z: 3.95 }, // Стол, верхний правый
  tableBottomLeft: { x: 4.5, y: 6.5, z: 3.95 }, // Стол, нижний левый
  tableBottomRight: { x: 6.5, y: 6.5, z: 3.95 }, // Стол, нижний правый
