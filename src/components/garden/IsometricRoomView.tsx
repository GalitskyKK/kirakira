...
const SLOT_POSITIONS = {
  ...
  // Стол (4 слота: 8-11)
  tableTopLeft: { x: 5.7, y: 5.7, z: 3.95 }, // Стол, верхний левый
  tableTopRight: { x: 7.2, y: 5.7, z: 3.95 }, // Стол, верхний правый
  tableBottomLeft: { x: 5.7, y: 7.2, z: 3.95 }, // Стол, нижний левый
  tableBottomRight: { x: 7.2, y: 7.2, z: 3.95 }, // Стол, нижний правый
