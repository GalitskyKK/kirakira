...
function CompanionLockedPreview({
  ...
  return (
    <div className="flex flex-col items-end gap-2">
      ...
      >
        <motion.div
          className="absolute bottom-0 h-6 w-12 rounded-full bg-slate-400/35 blur-lg dark:bg-slate-600/40"
          animate={{ scale: [0.9, 1.05, 0.9], opacity: [0.4, 0.7, 0.4] }}
          transition={{ duration: 2.8, repeat: Infinity, ease: 'easeInOut' }}
        />
        <div className="relative flex h-16 w-16 items-center justify-center rounded-full border border-dashed border-slate-400/50 bg-slate-200/40 shadow-inner dark:border-slate-600/50 dark:bg-slate-800/40">
          <motion.span
            className="text-lg text-slate-400/80 dark:text-slate-500/80"
      ...
      <div className="pointer-events-auto max-w-[220px] rounded-2xl bg-white/85 px-3 py-2 text-right shadow-lg backdrop-blur dark:bg-slate-900/85">
