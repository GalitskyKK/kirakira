...
interface ShopContentProps {
  ...
  readonly onTabChange: (tab: ShopTab) => void
  readonly onClose?: () => void
...
export function ShopContent({
  ...
  const containerClasses =
    variant === 'modal'
      ? 'relative flex max-h-[80vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-900'
      : 'relative mx-auto flex w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-neutral-200/70 bg-white shadow-sm dark:border-neutral-800 dark:bg-gray-900'
